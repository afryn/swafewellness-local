...
<div class="page-content bg-white">
    ...
    <section class="content-inner-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-left">
                    <div class="clearfix mb-2">
                        <h3 class="top_tit_bg text-center">Our <span>Gallery</span></h3>
                        <div class="dz-separator style-2 mb-5"></div>
                    </div>
                    <div class="site-filters style-5 clearfix m-b20 text-center">
                        ...
                        <ul class="filters filters5" data-bs-toggle="buttons">
                            ...
                            <?php if (!empty($allTags)) {
                                foreach ($allTags as $tags) {
                                    $tag_slug = str_replace(" ", "_", $tags);
                                    $tag_slug = preg_replace("/\./", "_", $tag_slug);
                                    ?>
                                    <li data-filter=".<?= $tag_slug; ?>" class="btn"><input type="radio"><a
            ...
            <div class="clearfix container" id="lightgallery5">
                <ul id="masonry5" class="dlab-gallery-listing gallery-grid-8 sp10 gallery text-center row">
                    ...
                    <?php foreach ($gallery as $img): 
                        ...
                        $tagsStr = '';
                        foreach ($tags as $tag) {
                            $tag_slug = str_replace(" ", "_", $tag);
                            $tag_slug = preg_replace("/\./", "_", $tag_slug);
                            $tagsStr .= ' '. $tag_slug;
                            } ?>

                        <div class="col-lg-2 card-container m-b10 col-lg-3 <?= $tagsStr;?>">
                            <a href="javascript:void(0)" data-src="<?= base_url();?>uploads/gallery/<?=$img->image ;?>"
                                class="dz-media dz-img-overlay4 rounded lg-item">
                                <img src="<?= base_url();?>uploads/gallery/<?=$img->image ;?>" alt="/" width="800" height="650">
                            </a>
                        </div>
                    <?php endforeach; ?>
                </ul>
