...
<div class="page-content bg-white">
    ...
    <div class="dz-bnr-inr style-1 text-center">
        <div class="container">
            <div class="dz-bnr-inr-entry">
                <h1>Moana Island Dubai</h1>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Moana Island Dubai</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
    ...
    width: 80%;
            ...
            margin: auto;
            left: 0;
            box-shadow: 0 1px 5px -2px #00000059;
            display: flex;
    ...
    font-weight: 700;
    margin-bottom: 15px;
    background: -webkit-linear-gradient(#dca562, #f6b661, #b59062);
    ...
    margin-bottom: 10px;
        ...
        .grid-item figure figcaption::after {
            ...
            transform: translateX(0) translateY(0) rotateZ(0) rotate(0deg) scale(.95);
            z-index: -1;
            opacity: 0;
        }
        ...
        .grid-item figure:hover figcaption {
            color: white;
            background-color: rgba(11, 206, 175, 0.9);
        }
        ...
        .grid-item figure:hover figcaption i {
            opacity: 1;
            transition: .2s;
            transform: translateX(0) translateY(0) translateZ(0) rotate(0deg) scale(1);
        }
        ...
        .wm.dark.wm-border {
            ...
            -webkit-text-stroke-color: rgb(184 162 162 / 20%);
        }
    ...
    padding: 30px 0px;
            ...
            .wm,  .wm.dark.wm-border { font-size: 45px;}
            .duyj ul{
                display:block;
    ...
    <!-- contact-box  -->
    <section class="newfeidcs">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-11">
                    <div class="ialandSec">
                        <img src="assets/images/moana.jpg" alt="">
                        <div class="feboxod">
                            <div class="duyj">
                                <h3 class="title">Moana Island Dubai (Special Package)</h3>
                                <ul>
                                    <li>Boat ride </li>
                                    <li>Food at cost </li>
                                    <li>Yoga</li>
                    ...
                    <div>
                        <div class="yoga-content">
                            <h3 class="title">Enjoy 3 days of Swafe Wellness Package for 3 people, all for just $5000 USD</h3>
                            <p class="text m-b0">Discover the Magic of Moana Island Dubai Your Daytime Escape in Paradise! Nestled in the crystal-clear waters of the Arabian Gulf, Moana Island invites you for a three-day adventure filled with tropical vibes, relaxation, and delicious food. </p>
                            <p class="text m-b0">Explore the beauty of this Pacific-inspired resort as it comes to life during the day, reflecting Dubai's dedication to creating unforgettable moments. Please note, Moana Island Dubai is exclusively open for day visits, offering a perfect blend of sun-soaked joy and luxury. Pack your bags for a getaway where every moment is a memory in the making!</p>
    ...
    <section class="srb-portfolio">
        <div class="wm wm-border dark aos-init" data-aos="fade-right" data-aos-duration="800">Moana Gallery</div>
        <div class="container">
                        ...
                        <div class="part col-sm-12">
                            ...
                            <div class="mh-project-gallery col-sm-12" id="project-gallery">
                                <div class="portfolioContainer row">
                                    ...
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-1.jpeg" alt="">
                                          
                                        </figure>
                                    </div>
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-4.jpeg" alt="">
                                          
                                        </figure>
                                    </div>
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-2.jpeg" alt="">
                                             
                                        </figure>
                                    </div>
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-3.jpeg" alt="">
                                    ...
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-5.jpeg" alt="">
                                    ...
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-7.jpeg" alt="">
                                            
                                        </figure>
                                    </div>
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-8.jpeg" alt="">
                                             
                                        </figure>
                                    </div>
                                    <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-10.jpeg" alt="">
                                             
                                        </figure>
                                    </div>
                                      <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-15.jpeg" alt="">
                                        </figure>
                                    </div>
                                      <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-12.jpeg" alt="">
                                        </figure>
                                    </div>
                                      <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-13.jpeg" alt="">
                                        </figure>
                                    </div>
                                      <div class="grid-item 5 col-md-4" id="portfolio-item">
                                        <figure>
                                            <img src="assets/images/partner-resort/resort-14.jpeg" alt="">
                                        </figure>
                                    </div>
