...
<div class="dz-bnr-inr style-1 text-center">
    ...
    <svg class="bg-image" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 1919 379" fill="none">
        ...
        <path
            ...
            fill="var(--theme-text-color)"></path>
        <path d="M234.557 199.849V286.201" stroke="var(--theme-text-color)" stroke-width="3.1879" stroke-miterlimit="10"
        ...
        <path d="M208.716 222.547C208.716 235.583 213.57 241.269 233.078 240.391" stroke="var(--theme-text-color)"
            stroke-width="3.1879" stroke-miterlimit="10" stroke-linecap="round"></path>
        <path d="M1025.74 221.899V308.251" stroke="var(--theme-text-color)" stroke-width="3.1879" stroke-miterlimit="10"
            stroke-linecap="round"></path>
        ...
        <path d="M999.894 244.597C999.894 257.633 1004.75 263.319 1024.26 262.441" stroke="var(--theme-text-color)"
            stroke-width="3.1879" stroke-miterlimit="10" stroke-linecap="round"></path>
        <path d="M1848.26 175.394V261.746" stroke="var(--theme-text-color)" stroke-width="3.1879" stroke-miterlimit="10"
            stroke-linecap="round"></path>
...
<section class="content-inner-1 overflow-hidden pb-0">
    <div class="container">
        <div class="clearfix mb-2">
            <h3 class="top_tit_bg">Swafe <span>Progammes</span></h3>
        ...
        <div class="row justify-content-center mt-5 mb-5">
            <?php
            $i = 0;
            foreach ($services as $pckg) { ?>

                <div class="col-lg-4 col-md-6">
                    <div class="dz-team m-b30 style-3">
                        <div class="dz-media">
                            <img src="<?= base_url('uploads/packages/').(($pckg->image != '') ? $pckg->image : "no-image.jpg") ?>" alt="">
                           
                        </div>
                        <div class="dz-content text-center">
                            <h5 class="dz-name"><a href="javascript:;"><?= $pckg->package_name;?></a></h5>
                            <div class="dlab-divider bg-gray text-gray icon-center"><i
                                    class="fas fa-circle bg-white text-gray-dark"></i></div>
                            <span>Nights: <strong><?= explode(':', $pckg->package_duration)[0];?> to <?= explode(':', $pckg->package_duration)[1];?></strong></span><br>
                            <p class="progrm_pp mt-1"><?= substr($pckg->description, 0, 85);?><?= (strlen($pckg->description) > 85)?'...' : '';?></p>
                            <div class="cll_to_ac d-flex">
                                <a href="<?= base_url('programme/').$pckg->slug;?>" class="hny_rd-morre" >Read More</a>
                               
                                  <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                        id="act_packages_<?= $pckg->id; ?>" class="modalBtn btn btn-rounded btn-primary m-b10 program_btn"
        ...
        <!-- <div class="row justify-content-center mt-5 mb-5">
            <div class="col-lg-4 col-md-6">
                <div class="dz-team m-b30 style-3">
                    <div class="dz-media">
                        <img src="assets/images/blog/blog-grid-2/pic4.jpg" alt="">
                        <div class="dz-social-icon text-center icon-gap-5">
                            <ul>
                                <li><a class="btn-social btn-transparent rounded" href="javascript:;">
                    ...
                    <div class="dz-content text-center">
                        <h5 class="dz-name"><a href="javascript:;">REJUVENATION</a></h5>
                        <div class="dlab-divider bg-gray text-gray icon-center"><i class="fas fa-circle bg-white text-gray-dark"></i></div>
                        <span>Nights: <strong>14, 21</strong></span><br>
                        <span class="mb-2">Level: <strong>Comprehensive</strong></span>
                        <p class="progrm_pp mt-1">Customized programme based on varying clinical presentations, stages of disease progression, and resultant symptoms</p>
                        <div class="cll_to_ac d-flex">
                            <a href="javascript:void(0);" class="hny_rd-morre">Read More</a>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn btn-rounded btn-primary m-b10" style="padding: 7px 22px;">Book Now
                                <span class="btn-icon-left"><i class="flaticon-sent"></i></span>
                            </button>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dz-team m-b30 style-3">
                    <div class="dz-media">
                        <img src="assets/images/blog/blog-grid-2/pic5.jpg" alt="">
                        <div class="dz-social-icon text-center icon-gap-5">
                            <ul>
                                <li><a class="btn-social btn-transparent rounded" href="javascript:;">
                                        <i class="fab fa-facebook-f"></i>
                    ...
                    <div class="dz-content text-center">
                        <h5 class="dz-name"><a href="javascript:;">WEIGHT MANAGEMENT</a></h5>
                        <div class="dlab-divider bg-gray text-gray icon-center"><i class="fas fa-circle bg-white text-gray-dark"></i></div>
                        <span>Nights: <strong>14 to 21</strong></span><br>
                        <span class="mb-2">Level: <strong>Comprehensive</strong></span>
                        <p class="progrm_pp mt-1">The Weight Management Programme is a safe and effective way to lose weight. Swafe is the perfect haven to gain control over your body</p>
                        <div class="cll_to_ac d-flex">
                            <a href="javascript:void(0);" class="hny_rd-morre">Read More</a>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn btn-rounded btn-primary m-b10" style="padding: 7px 22px;">Book Now
                                <span class="btn-icon-left"><i class="flaticon-sent"></i></span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="dz-team m-b30 style-3">
                    <div class="dz-media">
                        <img src="assets/images/blog/blog-grid-2/pic6.jpg" alt="">
                        <div class="dz-social-icon text-center icon-gap-5">
                            <ul>
                                <li><a class="btn-social btn-transparent rounded" href="javascript:;">
                                        <i class="fab fa-facebook-f"></i>
                    ...
                    <div class="dz-content text-center">
                        <h5 class="dz-name"><a href="javascript:;">CHRONIC PAIN MANAGEMENT</a></h5>
                        <div class="dlab-divider bg-gray text-gray icon-center"><i class="fas fa-circle bg-white text-gray-dark"></i></div>
                        <span>Nights: <strong>7 to 21</strong></span><br>
                        <span class="mb-2">Level: <strong>Comprehensive</strong></span>
                        <p class="progrm_pp mt-1">Swafe Pain Management is a holistic programme based on principles of Ayurveda & Physiotherapy</p>
                        <div class="cll_to_ac d-flex">
                            <a href="javascript:void(0);" class="hny_rd-morre">Read More</a>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn btn-rounded btn-primary m-b10" style="padding: 7px 22px;">Book Now
                                <span class="btn-icon-left"><i class="flaticon-sent"></i></span>
