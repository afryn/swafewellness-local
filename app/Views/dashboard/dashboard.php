...
<script>
  $(document).ready(function () {
    ...
    $.ajax({
      url: '<?= base_url(route_to('fetchChartData')); ?>',
      method: 'GET',
              ...
              <div class="col-12">
                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                  <div class="flex-grow-1">
                    ...
                    <h4 class="fs-16 mb-1">
                      <?= getDayPart() . ', ' . session()->get('first_name') . ' ' . session()->get('last_name'); ?>!
                    </h4>
                      ...
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                          <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            &#8377; <span class="counter-value" data-target="<?= $totalEarnings; ?>">0</span>
                          </h4>
                          <a href="<?= base_url(route_to('total.earnings')); ?>" class="text-decoration-underline">View
                            net
                            earnings</a>
                        </div>
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                          <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            <span class="counter-value" data-target="<?= count($totalAppointments); ?>">0</span>
                          </h4>
                          <a href="<?= base_url(route_to('appointments.list')) ?>" class="text-decoration-underline">View
                            all appointments</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                          <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            <span class="counter-value" data-target="<?= count($activeTrainers); ?>">0</span>
                          </h4>
                          <a href="<?= base_url(route_to('admin.trainers-list')) ?>" class="text-decoration-underline">See
                            details</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                          <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            <span class="counter-value" data-target="<?= count($activeCenters); ?>">0</span>
                          </h4>
                          <a href="<?= base_url(route_to('center.list')) ?>" class="text-decoration-underline">View
                            Centers List</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                          <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            <span class="counter-value" data-target="<?= count($activeProgrammes); ?>">0</span>
                          </h4>
                          <a href="<?= base_url(route_to('admin.packages-list')) ?>"
                            class="text-decoration-underline">View total programmes</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                          <span class="avatar-title bg-success rounded fs-3">
                            <i class="bx bx-dollar-circle"></i>
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                          <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            <span class="counter-value" data-target="<?= count($appInquiries); ?>">0</span>
                          </h4>
                          <a href="<?= base_url(route_to('inquiries.list')) ?>"
                            class="text-decoration-underline">Appointment Inquiries</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                          <span class="avatar-title bg-info rounded fs-3">
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                          <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            <span class="counter-value" data-target="<?= count($inquireis); ?>">0</span>
                          </h4>
                          <a href="<?= base_url(route_to('messages.list')) ?>" class="text-decoration-underline">View
                            Messages</a>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                          <span class="avatar-title bg-warning rounded fs-3">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                          <a href="javascript:void(0)" class="bg-light rounded p-1">
                            <img src="<?= base_url(); ?>assets/images/products/img-8.png" alt=""
                              class="img-fluid d-block" />
                          </a>
                          <a href="javascript:void(0)" class="bg-light rounded p-1">
                            <img src="<?= base_url(); ?>assets/images/products/img-2.png" alt=""
                              class="img-fluid d-block" />
                          </a>
                          <a href="javascript:void(0)" class="bg-light rounded p-1">
                            <img src="<?= base_url(); ?>assets/images/products/img-10.png" alt=""
                              class="img-fluid d-block" />
                          </a>
                        </div>
                            ...
                            <div class="d-flex">
                              <div class="flex-shrink-0 avatar-sm">
                                <div class="avatar-title bg-light rounded shadow">
                                  <img src="<?= base_url(); ?>assets/images/companies/img-1.png" alt="" height="30" />
                                </div>
                              </div>
                              <div class="flex-grow-1 ms-3">
                                <div>
                        ...
                        <div class="card border border-dashed shadow-none">
                          <div class="card-body">
                            <div class="d-flex">
                              <div class="flex-shrink-0 avatar-sm">
                                <div class="avatar-title bg-light rounded shadow">
                                  <img src="<?= base_url(); ?>assets/images/companies/img-8.png" alt="" height="30" />
                                </div>
                              </div>
                              <div class="flex-grow-1 ms-3">
                                <div>
